...
The purpose of this step is to create a database, migrate our schema in and set up a client.
...
Create a function `removeArtistFromRecordCompany`, which takes the same parameters as the previous function.
