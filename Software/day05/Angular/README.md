# PoC Software Pool 2025 - Day 05 - Angular 
...
- Create your first router and add endpoints for the `register` and `login` components
    - Check the documentation to discover how router works and how to call it in your app. Things can be hard to understand at first, but we are here to help 😄
