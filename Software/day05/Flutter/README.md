# PoC Software Pool 2025 - Day05 - Flutter
...
Here is the doc to know [how to make a main in Dart](https://dart.dev/guides/language/language-tour#the-main-function).
...
The keyword static just mean that you don't need to create an instance of Api to use it. As we only need one instance of Api class, we can let everything inside it static 😉

For example, here's how to use Api without static:
```dart
final Api api = Api();
...
Congratulations on completing this day 🚀
